    ...
    public function purify($string, $profile = 'default')
    {
        ...
        // default profile
            ...
            $config = load_htmlpurifier([
                'HTML.Allowed' => 'h2,h3,h4,h5,h6,pre[class],code,div[class],strong,em,p[style],li,ul,ol,img[src|alt],a[href|title|target|rel],video[controls|width|height],source[src|type],table[class|style],tbody,tr,td,iframe[src|width|height|allowfullscreen]',

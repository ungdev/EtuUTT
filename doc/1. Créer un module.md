...
Les système d'EtuUTT a été conçu pour facilement ajouter des fonctionnalités
...
Cependant, ce module, bien que créé, n'est pas activé. Vous avez alors deux choix :
 ...
 - ou bien vous l'activer depuis l'interface d'administration de EtuUTT si vous y
 avez accès ;
 - ou bien vous l'activer à la main en modifiant le fichier `app/config/modules.yml` :

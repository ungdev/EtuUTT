...
class StringManipulationExtension extends \Twig_Extension
{
	...
	/**
	 * Uncamelize a word. Converts 'CamelCase' to 'camel_case'
	 *
	 * @param  string $word  Word to uncamelize
	 * @return string $word  Uncamelized word
	 */
	...
	/**
	 * Camelize a word. Converts 'camel_case' to 'CamelCase'
	 *
	 * @param string  $word  Word to camelize
	 * @return string $word  Camelized word
	 */
	...
	/**
	 * Callback function to camelize a word properly.
	 *
	 ...
	 * @return string $text  Slugified text
	 */

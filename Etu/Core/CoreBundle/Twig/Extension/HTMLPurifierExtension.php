    ...
    public function purify($string, $profile = 'default')
    {
        ...
        // default profile
            ...
            $config = load_htmlpurifier([
                'HTML.Allowed' => 'h2[id],h3[id],h4[id],h5[id],h6[id],pre[class],code,div[class|style],strong,em,p[style],li,ul,ol,img[src|alt|style|height|width],a[href|title|target|rel],video[controls|width|height],source[src|type],table[class|style],tbody,tr,td,iframe[src|width|height|allowfullscreen],br,hr,figure[class],figcaption',
                'CSS.AllowTricky' => true,
                'CSS.AllowedProperties' => 'width,height,text-align,padding-left,max-width,max-height,margin-left,margin-right,display',
                'Attr.AllowedClasses' => 'align-center,alert,alert-error,alert-warning,alert-info,alert-success,pull-left,pull-right,mce-toc,table,table-bordered,'

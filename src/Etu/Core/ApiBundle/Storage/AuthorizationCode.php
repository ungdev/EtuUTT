...
namespace Etu\Core\ApiBundle\Storage;

use OAuth2\Storage\AuthorizationCodeInterface;
use Doctrine\ORM\EntityManager;
use Etu\Core\ApiBundle\Entity\Client;
...
class AuthorizationCode implements AuthorizationCodeInterface
{
    ...
    {
        // Get Code
        $code = $this->em->getRepository('EtuCoreApiBundle:AuthorizationCode')->find($code);
    ...
    {
        $client = $this->em->getRepository('EtuCoreApiBundle:Client')->find($client_id);

        if (!$client) throw new \Exception('Unknown client identifier');
        
        $authorizationCode = new \Etu\Core\ApiBundle\Entity\AuthorizationCode();
